...
"[Comfortable toes] good stability stocking, the fabric is not easy to slip, and the toes are not tight to avo"
        ],
      "specifications": [
        "24 inches",
...
"[Comfortable toes] good stability stocking, the fabric is not easy to slip, and the toes are not tight to avo"   
    ...
    },
  {
    ...
    price: 170,
    inventory: 58,
    imgUrl: "https://i.ibb.co/tMmxf6y/hush-nahotography-1v-Bex-Pe-DD3o-unsplash.jpg",
      mainCategory: "Fashion",
      subCategory: "Women's Fashion",
      category: "Clothing",
      topCategory: true,
